(() => {
    ...
    var S = `fs-${K}`, Fe = "list", _e = "filters", Ie = "empty", ve = "initial", Me = "results-count",
        ...
        kt = "fs-cmsfilter_highlight", Dt = "fs-cmsfilter_active", Kt = "50";
    var J = ({filtersData: e}) => {
    ...
    var {field: {key: Fr}, range: {key: _r}, type: {key: Ir}} = _, rt = class {
        ...
        async toggleFiltersState(t) {
            ...
            o !== s && (this.filtersActive = s, r.initialElement && (await r.displayElement(s ? "initialElement" : "smth", !1, !1), await r.displayElement(s ? "smth" : "initialElement", !0, o !== void 0)))
        }
